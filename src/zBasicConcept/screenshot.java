...
public class screenshot {
	public static void main(String[] args) throws IOException {
		...
		button.sendKeys("C:\\Users\\khima\\QA Automation Everything\\zTest\\screenshots\\Google.jpg");

		WebElement text = driver.findElement(By.xpath("//div[text()=\"Ready to Share!\"]"));
